        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Initiatives_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UserInitiativeKey = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Initiatives liées à la protection de l'environnement", "Environnement" },
                    { 2, "Initiatives liées aux transports et à la mobilité", "Transport" },
                    { 3, "Initiatives liées à la sécurité des citoyens", "Sécurité" },
                    { 4, "Initiatives culturelles et artistiques", "Culture" },
                    { 5, "Initiatives à caractère social et solidaire", "Social" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_UserInitiativeKey",
                table: "Votes",
                column: "UserInitiativeKey",
                unique: true);
        }
